...
class Waterfall(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        waterfall_0 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_0.png'), (60, 415))
        waterfall_1 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_1.png'), (60, 415))
        waterfall_2 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_2.png'), (60, 415))
        waterfall_3 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_3.png'), (60, 415))
        waterfall_4 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_4.png'), (60, 415))
        waterfall_5 = pygame.transform.scale(pygame.image.load('images/waterfall/waterfall_5.png'), (60, 415))
