...
class Waterfall(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        waterfall_0 = pygame.transform.scale(
            pygame.image.load(f'{img_root}0.png'), (60, 415))
        waterfall_1 = pygame.transform.scale(
            pygame.image.load(f'{img_root}1.png'), (60, 415))
        waterfall_2 = pygame.transform.scale(
            pygame.image.load(f'{img_root}2.png'), (60, 415))
        waterfall_3 = pygame.transform.scale(
            pygame.image.load(f'{img_root}3.png'), (60, 415))
        waterfall_4 = pygame.transform.scale(
            pygame.image.load(f'{img_root}4.png'), (60, 415))
        waterfall_5 = pygame.transform.scale(
            pygame.image.load(f'{img_root}5.png'), (60, 415))
