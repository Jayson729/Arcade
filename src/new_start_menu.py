import sys
import pygame
from main import currrent_time
...
class StartMenu(State):
    ...
    def create_game(self):
        ...
        self.menu_sound.set_volume(Settings.effects_volume)

        pygame.mixer.music.load('music/runescape_dream.wav')
        pygame.mixer.music.set_volume(Settings.music_volume)
        # loops music
        pygame.mixer.music.play(-1, currrent_time)
    ...
    def get_buttons(self) -> pygame.sprite.Group:
        ...
        def arcade_action():
            print('arcade')
            pygame.mixer.Channel.set_volume(pygame.mixer.Channel(0), Settings.effects_volume)
