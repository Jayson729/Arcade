...
class CreditsMenu(State):
    ...
    def get_menu_items(self):
        ...
        menu_items.add(Sprite(330, 165, font.render(
            'TEAM ARCADE', True, self.default_color)))
        menu_items.add(Sprite(280, 230, font.render(
            'Travis Johnson', True, self.default_color)))
        menu_items.add(Sprite(280, 280, font.render(
            'Brendan Kinder', True, self.default_color)))
        menu_items.add(Sprite(280, 330, font.render(
            'Ben Saunders', True, self.default_color)))
        menu_items.add(Sprite(280, 380, font.render(
            'Jayson Willey', True, self.default_color)))
        return menu_items
